...
## 서비스
- [Google Workspace 및 Colab](services/Google_Workspace_및_Colab)
- [ChatGPT Business](services/ChatGPT_Business)
- [OpenAI API Platform](services/OpenAI_API)
...
- [해외 결제 차단 대응](billing/해외_결제_차단_대응)
- [실제 비용과 True-up](billing/실제_비용과_True_up)

## 이슈 대응
- [Cursor Unpaid Admin 표시 오류 대응](issues/Cursor_Unpaid_Admin_표시_오류_대응)

## 컴플라이언스
- [개인정보 고지와 동의](compliance/개인정보_고지_동의)
- [정보보안 검토](compliance/정보보안_검토)
- [데이터 리텐션과 삭제](compliance/데이터_리텐션_삭제)
- [사고 대응](compliance/사고_대응)
