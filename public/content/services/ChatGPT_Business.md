...
대량 교육에서는 CSV를 쓰는 편이 편하다. 다만 CSV를 올리기 전에 중복과 오타를 잡아야 한다.
...
Owner는 결제와 설정에 접근한다. 교육생이나 일반 교육 담당자에게 Owner를 주지 않는다.
...
### 교육생이 개인 Gmail로 들어와도 되나?

기술적으로 가능할 수 있다. 하지만 조직 SSO, DLP, 계정 회수 통제가 약해진다. 그래서 개인정보 동의와 교육생 안내를 더 분명히 해야 한다.
