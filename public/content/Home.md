...
여기서 말하는 AI 계정은 단순히 “로그인 계정”만 뜻하지 않는다. 결제 카드, 라이선스, 팀 워크스페이스, API 키, Colab 컴퓨팅 단위, 교육생 안내문, 개인정보 동의서, 사고 대응 흐름까지 한 덩어리로 봐야 한다.

이 문서는 서비스 홍보용 소개서가 아니다. 실제 운영자가 헷갈리는 지점, 결제에서 막히는 지점, 교육생에게 꼭 말해야 하는 지점, 법무·보안 검토에서 자주 나오는 질문을 기준으로 정리한다.
...
| 프로젝트 실제 사례 | 본 프로젝트에서 실제로 겪었거나 문의했던 내용 | Colab Pro를 처음에는 2개만 살 수 있었던 상황, 월 구독액 절반 선결제 요구 |
| 운영 판단 | 공식 기준과 실제 사례를 섞어 만든 내부 운영 방식 | 교육 전 1명으로 테스트, 교육 종료 후 회수 로그 보관 |

공식 기준은 가능한 한 출처를 붙였다. 프로젝트 실제 사례는 “일반 규칙”으로 단정하지 않고, 별도 표시를 붙였다.
...
| ChatGPT Business | 팀 워크스페이스, 좌석, 멤버 초대, 데이터 처리, 교육생 사용 |
| OpenAI API Platform | 조직, 프로젝트, API 키, 서비스 계정, 사용량 예산 |
...
- [[education/교육생_주의사항|교육생 주의사항]]

### 양식과 Q&A

- [[templates/교육생_안내문|교육생 안내문]]
- [[templates/개인정보_고지서_동의서|개인정보 고지서·동의서]]
- [[qna/프로젝트_실제_QA|프로젝트 실제 Q&A]]
- [[glossary|용어 사전]]
- [[SOURCES|출처 모음]]
